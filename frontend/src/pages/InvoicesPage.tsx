...
function InvoicesPage() {
  ...
  // import { Search, ListFilter, MoreVertical } from 'react-feather';
  
  // const YourComponent = ({ darkMode, searchQuery, setSearchQuery, invoices }) => {
  ...
  //   return (
  //     <div className={`h-screen w-full flex flex-col ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
  //       <main className="p-6 w-full flex-1">
  //         <h1 className="text-2xl font-bold mb-6">Invoices</h1>
  
  //         {/* Search and Actions */}
  //         <div className="flex justify-between items-center mb-6">
  //           {/* ... (Search input and buttons remain the same) ... */}
  //           <div
  //             className={`relative flex-1 max-w-md ${darkMode ? "text-white" : "text-gray-900"
  //               }`}
  //           >
  ...
  //               className={`pl-10 pr-4 py-2 w-full rounded-lg ${darkMode
  ...
  //             <button
  //               className={`flex items-center px-4 py-2 rounded-lg ${darkMode
  ...
  //         {/* Table */}
  //         <div
  //           className={`rounded-lg overflow-x-auto shadow-sm  w-full flex-1 ${darkMode ? "bg-gray-800" : "bg-white"
  //             }`}
  //         >
  ...
  //                   <td className="px-6 py-4 whitespace-nowrap">
  //                     <span
  //                       className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadgeStyle(
  //                         invoice.status
  //                       )}`}
  //                     >
  //                       {invoice.status}
  ...
  // return (
  //   <div className={`h-full w-full flex ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
  ...
  //       {/* Table */}
  //       <div
  //         className={`rounded-lg overflow-x-auto shadow-sm  w-full ${darkMode ? "bg-gray-800" : "bg-white"
  //           }`}
  //       >
  //         <table className="w-full">
  //           <thead
   ...
   return (
    <div className={`h-full w-full flex ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
      <main className="p-6 w-full flex-1 overflow-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className={`relative flex-1 max-w-md ${darkMode ? 'text-white' : 'text-gray-900'}`}>
            <input
              type="text"
              placeholder="Search invoices"
              className={`pl-10 pr-4 py-2 w-full rounded-lg border focus:outline-none focus:ring-1 focus:ring-blue-500 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-300'
                }`}
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
          ...
          <div className="flex space-x-3">
            <button className={`px-4 py-2 rounded-lg border ${darkMode ? 'bg-gray-800 text-gray-200 border-gray-700' : 'bg-white text-gray-700 border-gray-300'
              }`}>
              Filters
            </button>
            <button className={`px-4 py-2 rounded-lg text-white ${darkMode ? 'bg-lime-600 hover:bg-lime-700' : 'bg-lime-500 hover:bg-lime-600'
              }`}>
              Create Invoice
            </button>
          </div>
        ...
        {/* Table */}
        <div className="rounded-lg overflow-x-auto shadow-sm w-full">
          <table className="w-full">
